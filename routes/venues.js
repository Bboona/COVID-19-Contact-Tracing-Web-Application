...

        {
          ...
          crypto.randomBytes(16, async function (err,salt){
            ...
            req.pool.getConnection( function(err,connection){
                  ...
                  /*`INSERT INTO venues (given_name,family_name,date_of_birth,email,contact_number,gender,COVID_contact,receive_email_1,receive_email_2,receive_email_3,username,password,street_number,street_name,suburb,zip_code,state,venue_code)
                                VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)`;*/
